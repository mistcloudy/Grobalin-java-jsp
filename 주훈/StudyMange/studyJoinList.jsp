...
<%}else{//글이 있는경우 %>
<table width="600" border="1" cellpadding="0" cellspacing="0" aling="center">
<tr height="30" bgcolor="<%=value_c%>">
<td align="center" width="50">스터디 번호</td>
<td align="center" width="250">보낸 사람</td>
<td align="center" width="100">보낸 날짜</td>
<td align="center" width="100">제목</td>
<td align="center" width="100">내용</td>
</tr>

<%for(int i=0;i<articleList.size();i++){
	StudyMangeVO article = (StudyMangeVO)articleList.get(i);
	%>
<tr height="30">
...
<%=article.getS_STUDYCODE() %></a>
<!-- 조회수가 많아지면 별도의 이미지로 표기(20회 이상) -->
</td>
<td align="center" width="100">>
<%=article.getM_MEMCODE() %></td>
<td align="center" width="100">
<%=article.getSC_JOINDAY() %></td>
<td align="center" width="100">
<%=article.getSJ_TITLE() %></td>
<td align="center" width="100">
<%=article.getSJ_CONTENT() %></td>
</tr>
...
%>
<form action="studyJoinList.jsp">
<select name="searchWhat">
<option value="writer">보낸 사람</option>
