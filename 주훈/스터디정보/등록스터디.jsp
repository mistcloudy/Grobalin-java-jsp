        ...
        <form action="#">
            <div class="user-details">
                <div class="input-box">
                    ...
                    <input type="text" name="name" value="<%= article.getM_MEMCODE()%>" readonly>
                </div>
                <div class="input-box">
                ...
                <div class="input-box">
                    ...
                    <input type="date" name="week" value="<%=article.getS_WEEK()%>" readonly>
                </div>
                <div class="input-box">
                    <span class="details">모임시간</span>
                    <input type="time" name="parttime" value="<%=article.getS_PARTTIME()%>"  readonly>
                </div>
                <div class="input-box">
                    <span class="details">모집 시간</span>
                    <input type="time" name="startday" value="<%=article.getS_STARTDAY()%>"  readonly>
                    <span></span>
                    <input type="time" name="endday" value="<%=article.getS_ENDDAY()%>" readonly>
                </div>
                <div class="input-box">
                    <span class="details">작성 날짜</span>
                    <input type="date" name="writeday" value="<%=article.getS_WRITEDAY()%>" readonly>
                </div>
                <span class="details">스터디 내용</span>
            </div>
            <div class="gender-details">
                <textarea placeholder="내용 입력" name="content" value="<%=article.getS_CONTENT()%>" readonly></textarea>
            </div>
            <div class="button">
                <input type="button" value="수정" onClick="location.href='/스터디정보/스터디수정.jsp'">
